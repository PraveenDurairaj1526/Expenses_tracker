    ...
    return (
        <header className='flex gap-3 items-center justify-end flex-row-reverse md:justify-between  md:flex-row mb-4'>
            ...
            <div className='md:flex md:gap-3 md:items-center'>
                <Button ripple={false} className='fixed rounded-full right-6 bottom-6 md:static flex gap-2 p-3 md:py-[10px] font-medium z-10 '  onClick={()=>{ dispatch(handleExpensesModalOpen('ADD'))}}> <PlusIcon className={'w-[14px] h-[14px]'} /> <span className='hidden capitalize md:flex'>Add Expenses</span></Button>
